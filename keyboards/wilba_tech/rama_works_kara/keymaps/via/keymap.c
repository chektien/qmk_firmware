...
// this was the default set by via template keymap.c file
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_60_hhkb(
	...
	// Fn2 Layer
	[2] = LAYOUT_60_hhkb(
		KC_TRNS, KC_MPRV, KC_MNXT, KC_MRWD, KC_MSTP, KC_MFFD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_F11, KC_MUTE, KC_VOLD, KC_VOLU,
